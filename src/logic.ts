...
export async function user_login(
  ...
  db.query(
    "INSERT INTO users (id, untis_username, untis_password, untis_school_name, untis_server, untis_qr_data, timetable, discord_user_id) VALUES ($id, $untis_username, $untis_password, $untis_school_name, $untis_server, $untis_qr_data, $timetable, $discord_user_id)"
  ).run({
    $id: uuid4(),
    $untis_username: user.untis_username,
